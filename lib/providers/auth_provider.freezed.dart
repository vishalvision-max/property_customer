...
class _$AuthStateImpl implements _AuthState {
  ...
  @override
  String toString() {
    return 'AuthState(isLoading: $isLoading, user: $user, error: $error, message: $message, seenOnboarding: $seenOnboarding)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isLoading, user, error, message, seenOnboarding);
